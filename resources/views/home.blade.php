...
<header id="home-header">
    ...
    <div class="header-sub-2">
        <a class="btn btn-blue" href="/create-campaign">Act now</a>
        @if (!Session::has('user'))
...
<div id="hero">
    ...
    <p>Find, and contribute to multiple campaigns.</p>
    <span>
...
<div class="intro">
    ...
    <div class="intro-2">
        <p>Want to make a new donation ?</p>
        <a href="/campaigns" class="btn-border">Donate now</a>
    </div>
