...
<footer class="footer">
  ...
  <div class="ctr">
    <div class="footer_inner">
      <div class="c-footer">
        <div class="lyt">
          <div class="lyt_item w-50">
            <div class="newsletter">
              <h3 class="newsletter_title">Get updates on campaigns you probably want to know about in your inbox.</h3>
          ...
          <div class="lyt_item w-25">
            <nav class="c-nav-tool">
              <h4 class="c-nav-tool_title">Menu</h4>
              <ul class="c-nav-tool_list">
                <li>
                  <a class="aa" href="/home" class="c-link">Home</a>
                </li>

                <li>
                  <a class="aa" href="/pages/about-us" class="c-link">About Us</a>
                </li>

                <li>
                  <a class="aa" href="/all-campaigns" class="c-link">Campaigns</a>
                </li>
                <li>
                  <a class="aa" href="#" class="my-donations">Donations</a>
                </li>
              </ul>
            </nav>
    ...
    <div class="cpyrights">
      <p>&copy; 2022 Azimut Company Inc.</p>
    </div>
  </div>
</footer>
					<!--end::Footer-->